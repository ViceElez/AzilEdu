...
namespace AzilEdu.Api.Migrations
{
    ...
    public partial class AddAnimalStatusRelation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("UPDATE Animals SET AnimalStatusId = 3 WHERE AnimalStatusId = 1;");
            migrationBuilder.Sql("UPDATE Animals SET AnimalStatusId = 1 WHERE AnimalStatusId = 0;");
