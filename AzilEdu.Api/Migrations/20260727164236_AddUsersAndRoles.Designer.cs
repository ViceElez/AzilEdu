...
namespace AzilEdu.Api.Migrations
{
    ...
    [Migration("20260727164236_AddUsersAndRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donations.DonationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donors.Donor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donors.DonorStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donors.DonorType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Employees.EmployeePosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.HousingUnits.HousingUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Volunteers.VolunteerTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Volunteers.VolunteerTaskStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Volunteers.VolunteerTaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donations.Donation", b =>
                {
                    ...
                    b.HasOne("AzilEdu.Shared.Models.Donations.DonationType", "DonationType")
                        .WithMany("Donations")
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Donors.Donor", b =>
                {
                    b.HasOne("AzilEdu.Shared.Models.Donors.DonorStatus", "DonorStatus")
                        .WithMany("Donors")
                        .HasForeignKey("DonorStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AzilEdu.Shared.Models.Donors.DonorType", "DonorType")
                        .WithMany("Donors")
            ...
            modelBuilder.Entity("AzilEdu.Shared.Models.Volunteers.VolunteerTask", b =>
                {
                    ...
                    b.HasOne("AzilEdu.Shared.Models.Volunteers.VolunteerTaskStatus", "VolunteerTaskStatus")
                        .WithMany("Tasks")
                        .HasForeignKey("VolunteerTaskStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AzilEdu.Shared.Models.Volunteers.VolunteerTaskType", "VolunteerTaskType")
                        .WithMany("Tasks")
